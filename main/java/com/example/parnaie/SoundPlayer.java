...
public class SoundPlayer {
    ...
    public SoundPlayer(Context context) {
        ...
        hitSound = soundPool.load(context, R.raw.gulp, 1);
        overSound = soundPool.load(context, R.raw.gameover, 2);
        menuMusic = soundPool.load(context,R.raw.music_menu,3);
    }
    ...
    public void playMenuMusic() {
        soundPool.play(menuMusic, 1.0f, 1.0f, 3, 0, 1.0f);
    }
